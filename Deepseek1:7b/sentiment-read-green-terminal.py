...
prompt_template = PromptTemplate.from_template(
    """
    [System Instructions]
    You are an AI assistant specialized in evaluating 
sentiment. 
    Your job is to determine whether a given sentence is 
...
def model_response_generator(input_text):
    ...
    stream = ollama.chat(
        model="deepseek-r1:7b",  # ใช้โมเดลจาก Ollama
        messages=[{"role": "user", "content": 
formatted_prompt}],  # ประวัติข้อความในการสนทนา
